...
public class PinyinToolTest {
  ...
  @Test
  public void main() throws BadHanyuPinyinOutputFormatCombination {
    PinyinToolTest tool = new PinyinToolTest();
    System.out.println(tool.toPinYin("我今"));
    // System.out.println(tool.toPinYin("商旅用车ABC"));
    // System.out.println(tool.toPinYin("商旅用车ABC","_"));
    // System.out.println(tool.toPinYin("商旅用车ABC","_", Type.LOWERCASE));
    // System.out.println(tool.toPinYin("商旅用车ABC","_", Type.UPPERCASE));
  }
